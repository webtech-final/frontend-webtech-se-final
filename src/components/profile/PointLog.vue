                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-900">
                            <tr>
                                <th
                                    colspan="3"
                                    class="px-6 py-3 text-center text-md font-medium text-white uppercase tracking-wider"
                                >
                                    POINT HISTORY
                                </th>
                            </tr>
                        ...
                        <thead class="bg-gray-200">
                            <tr>
                                <th
                                    scope="col"
                                    class="w-1/3 px-6 py-3 text-left text-xs font-medium text-black uppercase tracking-wider"
                                >
                                    DATE
                                </th>
                                <th
                                    scope="col"
                                    class="w-1/3 px-6 py-3 text-center text-xs font-medium text-black uppercase tracking-wider"
                                >
                                    TYPE
                                </th>
                                <th
                                    scope="col"
                                    class="w-1/3 px-6 py-3 text-right text-xs font-medium text-black uppercase tracking-wider"
                                >
                                    POINT
                                </th>
                            </tr>
