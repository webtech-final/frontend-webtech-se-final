                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <thead class="bg-gray-200">
                            <tr>
                                <th
                                    scope="col"
                                    class="w-1/2 px-6 py-3 text-left text-xs font-medium text-black uppercase tracking-wider"
                                >
                                    DATE
                                </th>
                                <th
                                    scope="col"
                                    class="w-1/2 px-6 py-3 text-right text-xs font-medium text-black uppercase tracking-wider"
                                >
                                    SCORE
                                </th>
                            </tr>
